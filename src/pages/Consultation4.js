    ...
    <div>
      ...
      <div class="container">
        <div className={styles.font}>
          ...
          그동안의 FTA로 관세는 줄었지만 리스크는 커졌고, FTA를 최대로 활용하기
          위해서는 보다 전문적인 지식이 필요하다는 것을 인식하게 되었습니다.
          <br />
          FTA 체약국간에 원산지검증 요청이 크게 증가하고 있으며 수입물품에 대한
          원산지 검증으로 관세 추징 사례가 증가하고 있습니다. 이에 따라 기업은
          FTA 활용을 어떻게 강화하느냐의 문제와 세관의 원산지 검증에 따른
          리스크를 최소화하는 방법이 중요 과제가 되었습니다.
          <br />
