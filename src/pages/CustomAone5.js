    ...
    <div>
      ...
      <div class="container">
        <div className={styles.font}>
          ...
          검역을 전담하는 팀을 구성하여 검역 대상물품에 대한 수출입 통관 대행과
          검역대행 One-Stop 서비스를 제공하며, 식품 수입시 위생조건, 검역조건
          등에 관하여 사전 검토를 하고 관련기관에 사전검역신청 등을 통하여
          검역상의 리스크를 제거하고 검역이나 수입 통관 과정에서 지적되는
          라벨링에 대한 보수작업도 함께 수행하고 있습니다.
          <br />
          <br />
          에이원은 국내 대부분의 검역대상 물품에 대한 검역경험을 갖고 있으며
          검역 교육을 이수한 전문가가 검역을 수행하고 있는 국내 최고의 검역 전문
          관세법인입니다.
          <br />
          <br />
