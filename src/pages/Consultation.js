    ...
    <div>
      ...
      <div class="container">
        <div className={styles.font}>
          ...
          대하여는 종합 심사를 실시하고 있습니다. 세관심사는 세율 적용의 적정성,
          FTA협정 적용의 적정성, 과세가격의 정확성, 외환거래의 적정성 등 모든
          통관의 적법성을 심사하게 됩니다.
          <br />
          <br />
          <h2>심사 ‘전문 컨설팅 그룹’의 책임있는 심사 대리 수행!!</h2>
          세관에서 경력을 쌓은 최고 전문가 (품목분류, 과세가격 평가, 외환거래,
          FTA 등 다양한 분야) 업계 최고의 전문관세사들로 구성되어 책임 있는 심사
          대리 수행 심사 종료 후에도 모든 절차가 종료될 때까지 책임 완수
