    ...
    <div>
      ...
      <div class="container">
        <div className={styles.font}>
          ...
          이익을 침해 당한 사람은 관세법에서 정하는 절차를 통하여 이를 구제 받을
          수 있습니다. 또한 관세법은 과세처분 전에 납세자의 신청에 의하여 그
          적정성이 사전에 재검토 될 수 있도록 하는 사전적 구제 제도도 마련하여
          납세자의 권리가 부당하게 침해될 가능성을 최소화 하고자 노력하고
          있습니다.
          <br />
          <br />
          그러나, 관세는 수많은 분야를 포함하고 있기 때문에 납세자 이익의 보호와
          환수는 이기는 방법을 아는 사람을 통하여 이길 수 있는 무기를 가지고
          이길 수 있도록 대응할 때 비로소 실현될 수 있습니다.
          <br />
          <br />
