    ...
    <div>
      ...
      <div class="container">
        <div className={styles.font}>
          ...
          <br />
          <br />
          고객사별로 수입전담직원을 배치하고 업무 매뉴얼을 작성하여 책임통관제를
          실시하고 있으며, 기 통관물품에 대한 지속적인 피드백을 통해
          관세리스크를 방지함으로써 고객만족을 실현하고 있습니다. 아울러
          고객사와의 업무협의 체를 가동하여 관세 무역에 관한 수시 동향 정보 및
          정기적인 통관 리스크에 대한 리포트를 제공하는 등 상시 업무 연락체제를
          유지함으로써 급변하는 국내외 통관 환경 변화에 능동적으로 대처하도록
          지원하고 있습니다.
          <br />
          <br />
          ...
          사전에 제거하고 있습니다. 고객정보 유출방지 시스템 등 관세리스크
          해소를 위한 다양한 시스템을 구축하여 운영함은 물론 전사적 차원의
          고객관리로 고객만족보증 서비스를 제공하고 있습니다.
          <br />
          <br />
          <br />
          <br />
