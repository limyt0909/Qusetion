        ...
        <Card>
          ...
          <Accordion.Collapse eventKey="0">
            <Card.Body>
              ...
              <br />
              <br />
              - 직무상의 기밀은 재중 중은 물론 퇴직 후라도 외부에 절대 누설하지
              않는다.
              <br />
              <br />
        ...
        <Card>
          ...
          <Accordion.Collapse eventKey="1">
            <Card.Body>
              ...
              하지 않는다. <br />
              <br />
              - 다른 회사의 사업활동 및 관습을 존중하며, 관계법령에 따라 적법한
              방법으로 거래를 행한다.
              <br />
              <br />
              ...
              <br />
              <br />
              - 모든 거래가 자유경쟁의 원칙에 따라 상호 대등한 지위에서 정당하고
              공정하게 이루어 질 수 있도록 노력한다.
              <br />
              <br />
            </Card.Body>
          </Accordion.Collapse>
        ...
        <Card>
          ...
          <Accordion.Collapse eventKey="1">
            <Card.Body>
              ...
              행정쟁송을 일괄 처리할 수 있는 실질적인 One Stop Service System을
              갖춘 관세법인.
              <br />
              <br />
              - 주요 공항과 항만에 지사를 설치하여 전국적 Network를 갖추고 있는
              국내 최대 규모의 관세법인.
              <br />
              <br />
